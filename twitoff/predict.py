...
def predict_user(user0_username, user1_username, hypo_tweet_text):
    ...
    # Combine the two users' word embedding into one big *2D* Numpy array
    # This is essentially our feature matrix X for training our logistic regression
    vects = np.vstack([user0_vects, user1_vects])

    # Create a numpy array to represent the target vector y
    # (indicate which user was the author of any given word embeddings)
    ...
    # Get the word embeddings for our hypothetical tweet
...
#print(predict_user('nasa', 'ryanallred', "moon lander telescope astronaut"))
